...
import privatService from "../service/privateService";
...
export default {
  data: () => ({
    ...
    searchString: "",
    drugs: [
      // { name: "Napa", weight: "500mg", vendor: "beximco", quantity: "10" },
      // { name: "Napa", weight: "500mg", vendor: "beximco", quantity: "10" },
      // { name: "Napa", weight: "500mg", vendor: "beximco", quantity: "10" },
      // { name: "Napa", weight: "500mg", vendor: "beximco", quantity: "10" },
      // { name: "Napa", weight: "500mg", vendor: "beximco", quantity: "10" },
      // { name: "Napa Extra", weight: "565mg", vendor: "SQUARE", quantity: "abc" }
    ],
    lastSearchTime: 0
  }),
  methods: {
